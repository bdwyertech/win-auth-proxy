...
func main() {
    ...
    proxy.OnResponse(HasNegotiateChallenge()).DoFunc(func(r *http.Response, ctx *goproxy.ProxyCtx)*http.Response {
        ...
        // Initialize Context
        tgt := "http/" + strings.ToUpper(strings.Replace(strings.Split(os.Args[1], ":")[1], "//", "", -1))
        ...
        transport := &http.Transport { Proxy: func (req *http.Request) (*url.URL, error) { return url.Parse(os.Args[1]) } }
